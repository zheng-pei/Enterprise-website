...
$(document).ready(function () { 
    ...
    $("#left div.subnav-title").click(function () {
		...
		if(_sub.parents(".subnav-new").length>0){
		 var _sib_p = _sub.parents(".subnav-new").siblings();//.find("i.icon-angle-down").parents(".subnav");	
			}
		else{
        	var _sib_p = _sub.parents(".subnav").siblings();//.find("i.icon-angle-down").parents(".subnav");
		}
    ...
    $(".subnav-menu a").click(function () {
       ...
       // $("ul.main-nav li").eq(0).addClass("active").siblings().removeClass("active");
		$(this).parents(".tab-content").find("li").removeClass("active");
