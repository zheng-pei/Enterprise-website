      ...
      <div class="span12">
        <div class="box">
          <div class="box-title">
            ...
            <div class="fr">
              <form name="searchform" action="<?php echo U('Messagereply/index');?>" method="post" class="form-horizontal">
             <input name="username" type="text" class="input-text" value="<?php echo ($username); ?>" placeholder=" 留言人姓名"/>&nbsp;
               ...
               <select class="input-medium" name="_sort" id="ver" data-rule-required="true" data-rule-notem="true">
                 ...
                 <option value="1" <?php if($isreply == '1'): ?>selected="selected"<?php endif; ?>>已回复</option><option value="2" <?php if($isreply == 2): ?>selected="selected"<?php endif; ?>>未回复</option>
                 </select>&nbsp; 
                ...
                <tbody>
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <input type="hidden" name="userid" value="{sk:vo.userid}">
                      ...
                      <td><?php echo ($replyman["username"]); ?></td>
                       <td class="statuscg">
                        <?php if($vo["isreply"] == 1): ?><span class="label label-success">已回复</span>
                        <?php else: ?>
                          <span class="label label-warning">未回复</span><?php endif; ?>
                      </td>              
                    <td>
                      <a href="<?php echo U('Messagereply/detail',array('userid'=> $vo['userid'],'id'=>$vo['id']));?>" class="btnra" title="查看">
