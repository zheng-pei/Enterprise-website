        ...
        <div class="box">
          ...
          <div class="box-content">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                <input type="text" name="createtime" readonly class="input-xlarge" data-rule-required="true" value="<?php echo (date("Y-m-d H:i:s",$info["leavemessage_time"])); ?>" />
                  </div>
              </div>
               <div class="control-group">
              ...
              <div class="control-group">
               ...
               <div class="control-group">
                <label for="createtime" class="control-label">回复时间：</label>
                <div class="controls">
                <input type="text" name="createtime" readonly class="input-xlarge" data-rule-required="true" value="<?php echo (date("Y-m-d H:i:s",$info["reply_time"])); ?>" />
                  </div>
              </div>
              <div class="control-group">
                <label for="replycontent" class="control-label">回复内容：</label>
                <div class="controls">
                  <textarea cols="30"  name="replycontent" row="20" readonly style="resize:none;width:500px;height:250px;"><?php echo ($info["replycontent"]); ?></textarea>
                </div>
              </div>
          </div>
        </div>
